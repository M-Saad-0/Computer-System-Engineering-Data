#Code can run from here also and from main.py too
...
class DownloadManager:
    ...
    def download_video(self):
        try:
            ...
            print("Downloading...")
            streams[0].download(filename="oop_project/video.mp4")
    ...
    def browse_file(self):
        ...
        shutil.copy(src_path, "oop_project/video.mp4")
        print("File Imported")
        
class SubtitleManager:
    def extract_audio(self):
        subprocess.run(["python", "oop_project/extract.py"])
        print("Audio Extracted")

    def write_subtitles(self):
        subprocess.run(["python", "oop_project/srt_creator.py"])
        print("Subtitles Written")

    def subbed_video(self):
        subprocess.run(["python", "oop_project/subbed_video.py"])
        print("Video With Subtitle")

    def lsten_video(self):
        subprocess.run(["python", "oop_project/listen.py"])
