function sig = audio_watermarking(host_audio_file, output_file, watermark_length, watermark_type)
    
    [host_audio, sample_rate] = audioread(host_audio_file);
    
    watermark = generate_watermark(watermark_length, watermark_type);
