...
clear;
close all;
spectrumAnalyzer4 = dsp.SpectrumAnalyzer('SpectrumType', 'Power','YLimits', [-100 0],'Title','Spectrum graph of female after low pass filtering');
step(spectrumAnalyzer4, LPF2);
% --- Transmitter Section ---

%% Import voice files
[maleVoice, Fs] = audioread('Male_voice.wav');
[femaleVoice, ~] = audioread('Female_voice.wav');
[randomVoice, ~] = audioread('random_sound.wav');
