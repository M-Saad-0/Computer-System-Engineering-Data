...
amMaleVoice = ammod(filteredMaleVoice, carrierFrequecyMale, Fs);
amFemaleVoice = ammod(filteredFemaleVoice, carrierFrequecyFemale, Fs);
amRandomSound = ammod(filteredRandomSound, carrierFrequecyRandom, Fs);
...
deModMaleVoice = amdemod(demuxMaleVoice, carrierFrequecyMale, Fs);
deModFemaleVoice = amdemod(demuxFemaleVoice, carrierFrequecyFemale, Fs);
deModRandomSound = amdemod(demuxRandomSound, carrierFrequecyRandom, Fs);
...
filteredMaleVoice = smooth(deModMaleVoice); %filter(lpf, 1, deModMaleVoice);
filteredFemaleVoice = smooth(deModFemaleVoice); %filter(lpf, 1, deModFemaleVoice);
filteredRandomSound = smooth(deModRandomSound); %filter(lpf, 1, deModRandomSound);
